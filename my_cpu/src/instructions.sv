...
`define POP_LOW 6'd11
`define POP_HIGH 6'd12

//immediate value push
`define PUSH_LOW 6'd13 //DO NOT INCREMENT THE STACK POINTER (It needs to be follow by a PUSH_HIGH instruction)
`define PUSH_HIGH 6'd14 //DO INCREMENTE THE STACK POINTER (MAKE SURE YOU PUSH_LOW FIRST!!)

//register value push & pop
`define PUSH 6'd15 //Push register content on the stack
...
`define SEND_UART 6'd22
`define READ_UART 6'd23

//INSTRUCTION TYPE
`define ALU_INSTRUCTION 2'd0
`define MEM_MAN_INSTRUCTION 2'd1
`define JUMP_INSTRUCTION 2'd2
`define UART_INSTRUCTION 2'd3
